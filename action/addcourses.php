...
<!-- body nav start-->
  ...
  <table class="table">
    ...
    elseif((int)$student_id == false){
        ...
        $marks = $myaction->insert_course($student_id, $sub);
        if($marks){
         echo "<div class='alert alert-success'><strong>Success! </strong>Successfully insert students Courses</div>";
         }
 }
        ...
        <tr>
         ...
         <td>
           <select name="course[]" multiple>
             ...
             <option>Computer Architecture CSE 6263</option>
             <option>Computer Pheripherals CSE 6264</option>
             <option>Programming in c CSE 6265</option>
             <option>Object oriended Programming CSE 6266</option>
             <option>compiler Design CSE 6266</option>
             <option>Physics NT 5567</option>
             <option>Bangla NT 5545</option>
             <option>English part 1 NT 5542</option>
             <option>Machine Design CSE 6267</option>
           </select>
